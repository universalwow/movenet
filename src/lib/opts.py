...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dense_hp', type=bool, default=True,
                                 help='loss weight for human keypoint heatmap.')
        self.parser.add_argument('--reg_offset', type=bool, default=True,
                                 help='loss weight for human keypoint heatmap.')
        self.parser.add_argument('--hm_hp', type=bool, default=True,
                                 help='loss weight for human keypoint heatmap.')
        self.parser.add_argument('--reg_hp_offset', type=bool, default=True,
                                 help='loss weight for human keypoint heatmap.')
        self.parser.add_argument('--eval_oracle_hmhp', type=bool, default=False,
                                 help='loss weight for human keypoint heatmap.')
        self.parser.add_argument('--eval_oracle_hm', type=bool, default=False,
                                 help='loss weight for human keypoint heatmap.')

        self.parser.add_argument('--eval_oracle_kps', type=bool, default=False,
                                 help='loss weight for human keypoint heatmap.')
        self.parser.add_argument('--eval_oracle_hp_offset', type=bool, default=False,
                                 help='loss weight for human keypoint heatmap.')
